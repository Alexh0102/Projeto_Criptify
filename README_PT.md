> 🌐 **English Version Available:** [Read README in English](README.md)
...
Para reportar vulnerabilidades ou discutir melhorias de segurança, consulte o arquivo [`SECURITY.md`](SECURITY.md) do repositório.
